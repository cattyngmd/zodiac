...
public class SmartOffhand extends Module {
    ...
    public SmartOffhand() {
        super("SmartOffhand", ":brain: offhand", Category.COMBAT, true);
        ...
        addSetting(health = new Setting("Health", this, 1, 10, 40));
        addSetting(crystalCheck = new Setting("CrystalCheck", this, true));
        addSetting(itemSetting = new Setting("Item", this, "Crystal", items));

    }

    @Override
    public void onUpdate() {
        if (itemSetting.getEnumValue().equalsIgnoreCase("Gapple")) item = Items.GOLDEN_APPLE;
